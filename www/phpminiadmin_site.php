...
*/
/*
VERSION MODIFIED FOR osa-fw CMS
*/

 @session_start();
 require_once "php/config.php" ;

 $access_level=100; #only admins can access
 if ($_SESSION['access_level']<100 || !$_SESSION['user']['id']){
    header('location: http://'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']).'/errors/401');
    exit;
 }
